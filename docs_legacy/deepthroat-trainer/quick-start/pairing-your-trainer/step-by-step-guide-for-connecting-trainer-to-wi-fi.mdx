...
<Steps>
<Step title="Power on and access settings">
  Turn on your Deepthroat Trainer. When you see the screen displaying "press button to start or hold to launch settings page," **hold the button** to access the settings menu.
</Step>
