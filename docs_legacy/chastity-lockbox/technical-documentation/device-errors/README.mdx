...
<CardGroup cols={2}>
  <Card title="E-LOCK-1: Could Not Lock" icon="lock" href="e-lock-1-could-not-lock">
    The device failed to engage the locking mechanism. Usually caused by obstruction or alignment issues.
  </Card>

  <Card title="E-LOCK-2: Could Not Unlock" icon="lock-open" href="e-lock-2-could-not-unlock">
    The device failed to disengage the locking mechanism. May require manual intervention.
  </Card>

  <Card title="E-LOCK-3: No Backplate Detected" icon="circle-exclamation" href="e-lock-3-no-backplate-detected">
...
<CardGroup cols={2}>
  <Card title="E-LOCK-10: Could Not Connect to Wi-Fi" icon="wifi-slash" href="e-lock-10-could-not-connect-to-wi-fi">
...
<CardGroup cols={2}>
  <Card title="E-LOCK-20: Emergency Unlock Used" icon="triangle-exclamation" href="e-lock-20-emergency-unlock-used">
