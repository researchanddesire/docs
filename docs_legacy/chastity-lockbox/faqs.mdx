...
<Accordion title="How do I pair my Lockbox to the dashboard?">
  ...
  <Card title="Quick Start Guide" icon="rocket" href="/chastity-lockbox/quick-start">
...
<Accordion title="How can I assign a Keyholder to my account?">
  ...
  <Card title="Connecting with Partners" icon="users" href="/dashboard/quick-start/connecting-with-other-users">
