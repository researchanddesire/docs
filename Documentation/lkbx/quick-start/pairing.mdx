...
<Step title="Scan for your Lockbox">
...
<Step title="Provide WiFi credentials (if needed)">
...
<Card title="Connect to WiFi first" icon="wifi" href="/lkbx/quick-start/wifi-setup">
...
<Steps>
<Step title="Find the pairing code on your device">
...
<Step title="Enter the code in the dashboard">
  ...
  <Note>
  If the dashboard reports **already paired** but the Lockbox doesn't appear under your account—often after a firmware update—see <a href="/lkbx/faqs#already-paired-error-but-my-lockbox-isnt-listed-on-my-account">this FAQ</a>.
  </Note>
</Step>
...
<AccordionGroup>
<Accordion title="Video walkthrough (manual pairing)">
