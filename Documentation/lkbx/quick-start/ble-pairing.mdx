...
<Warning>
Web Bluetooth is not supported in Firefox, Safari, or most mobile browsers. If you're on one of these, use [manual pairing with a pairing code](/lkbx/quick-start/pairing#option-2-manual-pairing-pairing-code) instead.
</Warning>
...
<AccordionGroup>
<Accordion title="My Lockbox doesn't appear in the browser picker">
...
<Accordion title="WiFi credentials were sent but the Lockbox didn't connect">
  ...
  - If the issue persists, try the [manual WiFi setup](/lkbx/quick-start/wifi-setup) flow instead
</Accordion>

<Accordion title="I see 'Scan for Lockbox' but clicking it does nothing">
