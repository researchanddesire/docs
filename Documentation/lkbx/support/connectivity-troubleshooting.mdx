...
- Pairing fails after following [the pairing guide](/lkbx/quick-start/pairing) — including confirming WiFi, using the current pairing code, and trying automatic pairing in Chrome or Edge if possible
