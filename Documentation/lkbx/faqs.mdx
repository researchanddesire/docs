...
<Accordion title="Can I unpair my Lockbox from all accounts?">
  ...
  Include the email for your dashboard or purchase, and the **pairing code** shown on the Lockbox under **Settings → Pairing** (support may refer to this as a pairing ID). An order number helps if you have it.
