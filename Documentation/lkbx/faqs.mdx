...
<Accordion title="The dashboard shows the wrong lock state (for example Unlocked while the Lockbox is locked), Device Status stuck on Updating, or 'Updating Firmware' never finishes">
