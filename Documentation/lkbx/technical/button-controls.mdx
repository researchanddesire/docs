...
<Steps>
<Step title="Press and hold the Enter button">
...
If your device is having sync issues with the dashboard—such as locks not applying correctly or unexpected unlocks—use the two-button hard reboot to force a full resync.

<Steps>
<Step title="Ensure device is charged">
Connect your device to power or verify it has sufficient battery.
</Step>

<Step title="Press and hold both buttons">
Press and hold both the **Enter/Lock** button and the **Back** button simultaneously.
</Step>

<Step title="Wait 5 seconds">
Keep holding both buttons for 5 seconds. The device will restart.
</Step>

<Step title="Wait for resync">
...
<Accordion title="Button presses but doesn't register">
...
<Accordion title="Device is completely unresponsive">
