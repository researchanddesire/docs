...
<Card title="Deepthroat Trainer" icon="bullseye-arrow" href="/dtt">
  Get started with your Deepthroat Trainer device.
</Card>

<Card title="Chastity Lockbox" icon="lock" href="/lkbx">
  Set up and use your Chastity Lockbox.
</Card>

<Card title="OSSM" icon="gear" href="/ossm">
  Open Source Sex Machine documentation.
</Card>

<Card title="Dashboard" icon="chart-line" href="/dashboard">
  Manage your devices and track progress.
</Card>
