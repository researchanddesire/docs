...
<AccordionGroup>
  ...
  <Accordion title="Can I change my shipping address?">
    ...
    <Note>
      Once your order has shipped, we cannot change the delivery address. Contact your carrier directly to request a package intercept or redirect (additional fees may apply).
    </Note>
  </Accordion>
