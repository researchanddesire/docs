...
<CardGroup cols={2}>
<Card title="OSSM: Basic Mount V2" icon="wrench" href="/open-source-sex-machine/ossm-basic-mount-v2">
Assembly notes and tips for the standard extrusion mount.
</Card>

<Card title="OSSM Ready‑to‑Play: Info Sheet" icon="info" href="/open-source-sex-machine/ossm-info-sheet-ready-to-play">
