...
- Default to hardware safety
  ...
  <Note>
  When the wireless remote loses connection, OSSM ramps down and pauses. Validate that your motion patterns recover safely after reconnect. See /research-and-desire-remote/quick-start.
  </Note>
...
- Electrical expectations
  - Specify a quality, UL‑listed 24V supply and current requirements. See /open-source-sex-machine/ossm-electronics/ossm-pcb-spec-sheet.
- Firmware and homing
  - Sensorless homing requires motion clearance. Instruct users to keep the rail area clear during homing and first power‑up. See /open-source-sex-machine/flashing-your-ossm.
...
- Electrical and power
  - Use a high‑quality 24V supply and verify polarity before powering on. See /open-source-sex-machine/ossm-electronics/ossm-pcb-spec-sheet.
  - Route and strain‑relieve cables away from moving parts. Follow wiring guidance for motors at /open-source-sex-machine/ossm-electronics/wiring-your-gold-motor.
- Firmware and controls
  - Flash recommended firmware and confirm homing works before mounting toys. See /open-source-sex-machine/flashing-your-ossm.
  - Verify the stop control works (wired remote or RADR stop) and is reachable during use. See /research-and-desire-remote/quick-start.
- Covers and guards
...
<Steps>
  <Step title="Understand the risks">
    Read the OSSM safety notes at /open-source-sex-machine/ossm-ready-to-play/ossm-info-sheet-ready-to-play. Keep fingers, hair, and clothing away from belts and the rail.
  </Step>
  ...
  <Note>
    See /research-and-desire-remote/quick-start for pairing, reconnect behavior, and control basics.
  </Note>
  </Step>
...
- OSSM safety notes and setup: /open-source-sex-machine/ossm-ready-to-play/ossm-info-sheet-ready-to-play
- Flashing firmware: /open-source-sex-machine/flashing-your-ossm
- PCB power specs (24V, current, protection): /open-source-sex-machine/ossm-electronics/ossm-pcb-spec-sheet
- Motor wiring: /open-source-sex-machine/ossm-electronics/wiring-your-gold-motor
- Wireless remote pairing and safety behavior: /research-and-desire-remote/quick-start
