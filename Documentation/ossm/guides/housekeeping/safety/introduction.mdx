...
<Tip>
If you use the Wireless Remote (RADR), the OSSM will automatically slow and pause if the connection is not re‑established quickly. You also have a dedicated pause/stop control on the remote. See /research-and-desire-remote/quick-start for details.
</Tip>
