...
<Tip>
If your DIY Kit came with a middle pivot body and you want the PitClamp Mini mounting system instead, you can print the PitClamp parts yourself using the files from GitHub.
</Tip>
</Accordion>
