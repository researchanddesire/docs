...
<Tip>
**Shipping internationally?** The lead times above are **warehouse processing** only. After your order ships, add **courier transit** (per your checkout option) and possible **customs** delay. The longer **Ready-to-Play** build time does **not** apply to DIY Kit orders. See [How long does shipping take?](/shop/faqs/introduction#how-long-does-shipping-take) in the Shipping FAQs. For destination limits (for example **Russia** and **Kazakhstan**), see [Do you ship to Russia or Kazakhstan?](/shop/faqs/introduction#do-you-ship-to-russia-or-kazakhstan). We do **not** ship via **DHL** or to **DHL Packstation** addresses—see [Can you ship via DHL or to a DHL Packstation?](/shop/faqs/introduction#can-you-ship-via-dhl-or-to-a-dhl-packstation).
