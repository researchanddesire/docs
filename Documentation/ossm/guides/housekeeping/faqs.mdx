...
<Tip>
**Shipping internationally?** The lead times above are **warehouse processing** only. After your order ships, add **courier transit** (per your checkout option) and possible **customs** delay. The longer **Ready-to-Play** build time does **not** apply to DIY Kit orders. See [How long does shipping take?](/shop/faqs/introduction#how-long-does-shipping-take) in the Shipping FAQs.
</Tip>
...
4. Support will send you an invoice for the replacement parts
