...
<Note>
Contents may vary slightly based on your order options. If something is missing, reach out via /contact.
</Note>
...
- If you have the wireless remote (RADR), charge it via USB‑C before pairing. See /research-and-desire-remote/quick-start.

<Tip>
Keep your firmware current for best performance. Update instructions: /open-source-sex-machine/flashing-your-ossm
</Tip>
...
- If using the wireless remote (RADR), power it on and follow /research-and-desire-remote/quick-start.
</Step>
...
<Note>
You are responsible for your setup and safety. If anything is unclear, pause and seek help in the community or contact support via /contact.
</Note>
...
<Tip>
Use a high‑quality, UL‑listed 24V supply and check for firm barrel‑jack connection at the board. See board specifications at /open-source-sex-machine/ossm-electronics/ossm-pcb-spec-sheet.
</Tip>
...
<Info>
Using the wireless remote (RADR)? If Bluetooth disconnects during play, the OSSM will ramp down and pause as a safety precaution. For pairing and recovery tips, see /research-and-desire-remote/quick-start.
</Info>
...
- Remote won’t connect:
  ...
  - Wireless (RADR): charge the remote, power-cycle both devices, and retry pairing using /research-and-desire-remote/quick-start.
- Firmware mismatch or issues: update using /open-source-sex-machine/flashing-your-ossm.
...
<Tip>
Need help or have feedback? We’re here for you: /contact
</Tip>
