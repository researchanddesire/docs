...
- If using the RADR wireless remote, update your OSSM firmware to 2.0.0 or newer. See /open-source-sex-machine/flashing-your-ossm
...
- Confirm your OSSM runs firmware 2.0.0+ (update via /open-source-sex-machine/flashing-your-ossm).
- Leave the OSSM powered off for now; you will power it on in the next step.
- Ensure the RADR has charge and is within a few feet of the OSSM. For control basics, see /research-and-desire-remote/quick-start.
...
<Warning>
If the actuator retracts first and then extends (reversed direction), power off and review your motor wiring before continuing. See /open-source-sex-machine/ossm-electronics/wiring-your-gold-motor
</Warning>
...
<Info>
For RADR control details (Play Controls and Pattern Mode), see /research-and-desire-remote/quick-start
</Info>
...
<Tip>
On RADR, a single press of the middle button pauses; a double press stops and resets to defaults. See /research-and-desire-remote/quick-start for control references.
</Tip>
...
- If still stuck, recheck motor wiring: /open-source-sex-machine/ossm-electronics/wiring-your-gold-motor
</Accordion>

<Accordion title="Movement direction is reversed">
- Power off immediately
- Verify motor phase wiring order and polarity
- Correct wiring per /open-source-sex-machine/ossm-electronics/wiring-your-gold-motor, then retest
</Accordion>
...
- See /research-and-desire-remote/quick-start and /research-and-desire-remote/device-support
</Accordion>
