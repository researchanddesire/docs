...
The frame is the structural stand that holds and positions the actuator. You can build on the basic mount or an extrusion stand depending on your setup. See <a href="/open-source-sex-machine/ossm-basic-mount-v2">OSSM: Basic Mount V2</a> for mounting options.
...
- If you haven’t chosen a stand yet, see <a href="/open-source-sex-machine/ossm-basic-mount-v2">OSSM: Basic Mount V2</a>.
