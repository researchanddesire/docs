...
<br />
Contact support: /contact (typical reply within 1 business day).
</Warning>

<Warning>
Security or safety vulnerabilities: do not post publicly. Contact support via /contact and include “Security report” in the subject. Provide a minimal, reproducible description and affected versions.
</Warning>

<Note>
If your problem is with the Wireless Remote (RADR) pairing or behavior, review the quick start first: /research-and-desire-remote/quick-start.
</Note>
...
- For software/firmware
  ...
  - If you recently updated, note how you flashed it: see /open-source-sex-machine/flashing-your-ossm
...
- For hardware/mechanical
  ...
  - Assembly or wiring references if relevant (e.g., /open-source-sex-machine/ossm-electronics/wiring-your-gold-motor)
...
<Check>
You should have an issue number and notifications enabled. If you contacted support via /contact, check for a confirmation email within 1 business day.
</Check>
</Step>
</Steps>
...
Re‑flash the device using the web flasher and verify the version shown during flashing. Guide: /open-source-sex-machine/flashing-your-ossm
</Accordion>

<Accordion title="Motor not moving or moving erratically">
Check wiring order and terminations for the Gold Motor. Guide: /open-source-sex-machine/ossm-electronics/wiring-your-gold-motor
</Accordion>

<Accordion title="Wireless Remote (RADR) won’t pair or drops connection">
Walk through the quick start and reconnection steps: /research-and-desire-remote/quick-start
</Accordion>
</AccordionGroup>
...
<Info>
Need help deciding whether something belongs in GitHub or support? If money changed hands (orders, shipments, defects, warranty), start at /contact. If it’s about the open source design, CAD, firmware, or docs, open a GitHub issue.
</Info>
