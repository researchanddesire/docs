...
- Devices are registered to the correct account (see device ownership guidance in /dashboard/faqs/device-ownership-dispute-policy)
...
Send the invite. Your partner will receive an in-app notification (and an email if they’ve enabled Sharing Events in /dashboard/settings/email-preferences). The connection becomes Active once they accept.
...
<Info>
For Lockbox users: enabling Give Up Control hands full control to your assigned partner and disables your own lock actions. See details in /chastity-lockbox/faqs.
</Info>
...
- Confirm the device is registered to the owner’s account (see /dashboard/faqs/device-ownership-dispute-policy)
- Refresh the dashboard after acceptance
- For Lockbox, make sure the correct account has control (see Give Up Control in /chastity-lockbox/faqs)
</Accordion>
...
- Make sure Sharing Events notifications are enabled in /dashboard/settings/email-preferences if you expect email alerts
</Accordion>
</AccordionGroup>
