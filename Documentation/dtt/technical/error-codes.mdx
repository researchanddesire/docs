...
**Cause**: Your movement speed is below the expected range.
...
<AccordionGroup>
<Accordion title="Device shows error then freezes">
...
<Accordion title="Error appears immediately after power-on">
- Wait for the device to complete startup
- Check Wi-Fi connection
- Try connecting to a different network
</Accordion>

<Accordion title="Errors during training">
