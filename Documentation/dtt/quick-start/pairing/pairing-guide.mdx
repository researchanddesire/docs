...
<Note>
Before you start, make sure your trainer is charged and that you can sign in to your dashboard account. For live syncing and remote features, connect your trainer to Wi‑Fi after pairing. See <a href="/deepthroat-trainer/quick-start/pairing-your-trainer/step-by-step-guide-for-connecting-trainer-to-wi-fi">Connect your trainer to Wi‑Fi</a>.
</Note>
...
<Info>
Want live syncing and remote features? After pairing, connect your trainer to Wi‑Fi: <a href="/deepthroat-trainer/quick-start/pairing-your-trainer/step-by-step-guide-for-connecting-trainer-to-wi-fi">Connect your trainer to Wi‑Fi</a>.
</Info>

<Warning>
Transferring a previously paired device? The current owner must unpair it from their account before you can pair it. For how ownership is determined and transfers are handled, see <a href="/dashboard/faqs/device-ownership-dispute-policy">Device ownership policy</a>.
</Warning>
...
Ask the current owner to unpair it from their account. If you can’t reach them, review the <a href="/dashboard/faqs/device-ownership-dispute-policy">ownership policy</a> and contact support for assistance.
</Accordion>
