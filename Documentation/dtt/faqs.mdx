...
If your trainer gets stuck on "I'm getting your settings from the dashboard" and won't proceed, the device is having trouble communicating with the R+D server or loading your template data.
=======
...
>>>>>>> origin/main
    ...
    **If the issue started after a firmware update:**
    ...
    1. **Try manual USB flashing** — Use the [Web Flasher](https://dashboard.researchanddesire.com/app/tools/web-flasher) to reinstall firmware. See the <a href="/dtt/technical/firmware-updates">
       Firmware Updates</a>
...
<AccordionGroup>
  <Accordion title="How do I sell or donate my Deepthroat Trainer?">
    ...
    <Info>
      Once unpaired, the next person to pair the device becomes the new owner. See the <a href="/dashboard/faqs/ownership-disputes">
...
<Card title="Device Ownership Policy" icon="shield" href="/dashboard/faqs/ownership-disputes">
