...
<AccordionGroup>
  ...
  <Accordion title="Can I use the vibrating plug and wand at the same time?">
    ...
    **How to use the wand:** The wand is designed for external stimulation. Hold it in place manually, tuck it into underwear, or position it however works best for you.
    ...
    <Card title="Accessory Port" icon="plug" href="/deepthroat-trainer/device-specifications/accessory-port">
...
<AccordionGroup>
  <Accordion title="How do I recalibrate my toy's depth setting?">
    If you've improved and your current calibration feels too shallow, you can reset it and recalibrate:

    1. In the dashboard, go to **Toybox**
    2. Select the toy you want to recalibrate
    3. Click **Reset Calibration** to clear the stored depth data
    4. On your next session with that toy, the trainer will prompt you to calibrate again—set your new comfortable depth

    <Card title="Calibration Guide" icon="sliders" href="/dtt/technical/calibration">
      Full calibration instructions and troubleshooting.
    </Card>
  </Accordion>
  <Accordion title="Can I recalibrate my toy mid-session?">
    No. Calibration changes cannot take effect during an active session. The Trainer downloads your calibration data when it boots up, so any changes you make in the dashboard require a device restart to apply.

    **To recalibrate:**

    1. End your current session
    2. In the dashboard, go to **Toybox**, select your toy, and click **Reset Calibration**
    3. Power cycle your Trainer (turn it off and back on)
    4. Start a new session—the Trainer will prompt you to calibrate with your new depth
  ...
  <Accordion title="Training requires depths that are physically impossible to reach">
    If your Trainer is asking you to go deeper than you can physically reach—even when touching your nose to the sensor—your calibration minimum position is set too close to the sensor.

    This commonly happens when:
    - You calibrated at an extreme depth you can't consistently reach
    - Training segments with depth scaling push beyond your calibrated range
    - Fast-paced segments (300+ RPM) require the deepest positions in the final reps

    **How to fix:**

    1. In the dashboard, go to **Toybox** and select your toy
    2. Adjust the calibration minimum position to start at **5 cm** (or further from the sensor)
    3. Power cycle your Trainer to load the updated calibration
    4. Start a new session

    Setting a more conservative minimum position (5 cm instead of 2 cm) ensures the deepest required depth is always physically achievable.

    <Tip>
      If you have a keyholder or partner managing your settings, they can adjust your toy calibration on your behalf.
    </Tip>

    <Note>
      The sensor has a dead zone within 1.7 cm where it cannot accurately detect position. Setting your minimum to 5 cm keeps you well outside this zone and prevents impossible depth requirements.
    </Note>
...
<AccordionGroup>
  ...
  <Accordion title="Templates not syncing — device runs default/demo mode instead">
...
<AccordionGroup>
  ...
  <Accordion title="How do I know if my firmware is up to date?">
  ...
  <Accordion title="Is my older Trainer eligible for firmware updates?">
  ...
  <Accordion title="Wi-Fi doesn't stay connected after restarting the device">
...
<AccordionGroup>
<Accordion title="I can't access my dashboard account. How do I unpair my device?">
...
<AccordionGroup>
  <Accordion title="Toybox and template buttons are greyed out">
  ...
  <Accordion title="Can't find the settings menu on my device">
  ...
  <Accordion title="Can I replace the battery in my Trainer?">
  ...
  <Accordion title="Accessory port only works at certain angles or has intermittent connection">
...
<AccordionGroup>
  <Accordion title="How does the Trainer appear on my WiFi network?">
...
<AccordionGroup>
  <Accordion title="Is there an open API for the Deepthroat Trainer?">
...
<AccordionGroup>
  ...
  <Accordion title="How long does the battery last, and how long does it take to charge?">
