...
<AccordionGroup>
  <Accordion title="Do I need a special app or paid software to use the Trainer?">
    ...
    **Cost:** Using the dashboard for core training—account, pairing, templates, session history, and standard modes—is **free**. **Ultra** is an optional subscription for advanced template features (for example, AI schedules, segment repeats, and Hands‑Free mode). See current plans and pricing on the subscription page.
    ...
    <CardGroup cols={2}>
      <Card title="Quick Start" icon="play" href="/dtt/quick-start/introduction">
...
<AccordionGroup>
  ...
  <Accordion title="How do I connect the wand to the Trainer? Do I need to take it apart?">
...
<AccordionGroup>
  <Accordion title="The Trainer no longer asks me to calibrate at my mouth before a session">
    ...
    <Card title="Calibration" icon="sliders" href="/dtt/technical/calibration#toybox-depth-settings">
...
<Accordion title="I'm signed in, but my Trainer doesn't appear under Devices and pairing says it's already registered">
...
<Card title="Pairing guide" icon="plug" href="/dtt/quick-start/pairing/pairing-guide">
  Step-by-step pairing and troubleshooting when the device is already paired.
</Card>
</Accordion>
<Accordion title="How do I delete my account or remove my personal data?">
...
<Card title="Dashboard: account deletion" icon="user-minus" href="/dashboard/faqs">
...
<AccordionGroup>
  ...
  <Accordion title="Upload a file or toy photo in Toybox doesn't work">
    ...
    <Card title="Toybox and toy photos" icon="box" href="/dtt/quick-start/using-toys">
  ...
  <Accordion title="Accessory port intermittent, or jack loose / recessed into the device">
...
<AccordionGroup>
  <Accordion title="Does the Deepthroat Trainer have a camera?">
    ...
    For what uploads when you train on Wi‑Fi (session metrics, dashboard, and optional leaderboard visibility), see <a href="/dtt/quick-start/checking-results">Checking Your Results</a>.
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="The dashboard shows a different Trainer ID than my device">
