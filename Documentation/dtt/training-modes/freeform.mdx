...
<Info>
On the latest beta firmware, the Freeform dial is replaced by Speed Mode. Behavior is the same: you aim to keep your RPM in the target zone. See /deepthroat-trainer/deepthroat-trainer-software-2.0.0-beta-preview for details.
</Info>
...
<Warning>
If you haven’t calibrated depth on this toy, do that first in a structured mode (e.g., /deepthroat-trainer/training-modes/repetition) so measurements are accurate.
</Warning>
</Step>
...
Start the session from your device. Maintain your chosen pace and depth while keeping your average near the RPM target. If you enabled Hands‑Free Mode in your template (Ultra), segments will advance automatically. See /deepthroat-trainer/faqs for details.
...
<Check>
On the dashboard, you can see session duration, RPM tracking, and your score. For how points work on leaderboards, see /dashboard/leaderboards/points.
</Check>
</Step>
</Steps>
...
- Your leaderboard points reflect session performance and duration. See /dashboard/leaderboards/points for the current breakdown.
