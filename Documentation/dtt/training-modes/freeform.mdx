...
<Info>
On the latest beta firmware, the Freeform dial is replaced by Speed Mode. Behavior is the same: you aim to keep your RPM in the target zone. See <a href="/deepthroat-trainer/deepthroat-trainer-software-2.0.0-beta-preview">Software 2.0.0 Beta Preview</a> for details.
</Info>
...
<Warning>
If you haven’t calibrated depth on this toy, do that first in a structured mode (e.g., <a href="/deepthroat-trainer/training-modes/repetition">Repetition</a>) so measurements are accurate.
</Warning>
</Step>
...
Start the session from your device. Maintain your chosen pace and depth while keeping your average near the RPM target. If you enabled Hands‑Free Mode in your template (Ultra), segments will advance automatically. See <a href="/deepthroat-trainer/faqs">DTT FAQs</a> for details.
...
<Check>
On the dashboard, you can see session duration, RPM tracking, and your score. For how points work on leaderboards, see <a href="/dashboard/leaderboards/points">Points</a>.
</Check>
</Step>
</Steps>
...
- Your leaderboard points reflect session performance and duration. See <a href="/dashboard/leaderboards/points">Points</a> for the current breakdown.
...
<Card title="Endurance Mode" icon="clock" href="/deepthroat-trainer/training-modes/endurance">
Focus on sustained depth and pacing over time.
</Card>

<Card title="Shareable Templates" icon="users" href="/deepthroat-trainer/training-modes/shareable-templates">
Explore community templates and import your favorites (Ultra).
</Card>

<Card title="Beta Preview" icon="sparkles" href="/deepthroat-trainer/deepthroat-trainer-software-2.0.0-beta-preview">
