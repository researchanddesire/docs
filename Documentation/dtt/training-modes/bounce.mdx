...
<Info>
Bounce Mode is excellent for building coordination and muscle memory. If you're just getting started, master <a href="/dtt/training-modes/repetition">Repetition Mode</a> first.
</Info>
...
<Step title="Start training and match the target">
...
<AccordionGroup>
<Accordion title="My score drops during withdrawal">
...
<Accordion title="The target seems to move unpredictably">
...
<Accordion title="I keep getting yellow/red during direction changes">
