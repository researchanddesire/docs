...
<Tip>
<strong>Ultra exclusive</strong> — Free users can add up to 3 segments per template.
</Tip>

The firmware now supports up to <strong>1,000 segments per training session</strong> (previously 3). However, the dashboard limits depend on your subscription tier:

| Plan  | Maximum Segments |
| ----- | ---------------- |
| Free  | 3                |
| Ultra | 100              |
