...
The firmware now supports up to <strong>1,000 segments per training session</strong> (previously 3). Dashboard UI for editing large segment sets is in development.

### Segment repeat

<Tip>
<strong>Ultra exclusive</strong> — Build longer, more efficient training templates without manual duplication.
</Tip>

- Set any segment to repeat up to 100 times
...
<CardGroup cols={2}>
  <Card title="Customize your avatar" icon="user" href="/dashboard/settings">
  ...
  <Card title="Unlock your first avatar" icon="gift" href="/dashboard/faqs">
...
<Steps>
<Step title="Enable Hands-free Mode on a template">
...
<Steps>
<Step title="Verify Speed mode feedback">
...
<Steps>
<Step title="Prepare for offline use">
...
<CardGroup cols={2}>
  <Card title="Ultra subscription benefits" icon="bolt" href="/dashboard/subscription">
    Learn what’s included in Ultra and how to upgrade.
  </Card>
  <Card title="Deepthroat Trainer FAQs" icon="question-mark-circle" href="/deepthroat-trainer/faqs">
...
<Card title="Browse Shareable Templates" icon="collection" href="/deepthroat-trainer/training-modes/shareable-templates">
