...
<Note>
RADR only connects to supported devices. See <a href="./device-support">Device support</a> for details.
</Note>
...
With both devices on and nearby, RADR pairs automatically within seconds.

<Check>
The Play Controls screen appears and shows your connected device.
</Check>
</Step>
</Steps>
...
| Middle button | Single press: pause. Double press: stop and reset to defaults |
| Right button | Open Pattern Mode |

<Tip>
Use the bumpers to switch modes without looking down. The on‑screen indicator shows the current mode.
</Tip>
...
<Card title="Firmware updates" icon="download" href="/open-source-sex-machine/flashing-your-ossm">
